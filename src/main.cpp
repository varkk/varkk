...
int64 nChainStartTime = 1495936355;
...
const string strMessageMagic = "VARKK Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    else if(nHeight > 100 && nHeight <= 10512100)
    {
        nSubsidy = 9.5 * COIN;
    }
    else if(nHeight > 10512100 )
   {
       nSubsidy = 0 * COIN;
   }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in VARKK
    bool fStrictPayToScriptHash = true; // Always active in VARKK
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "VARKK", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector VARKK empty mapBlockIndex VARKK VARKK";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x671d98d01227cbd8747c88ed1a6eebee1d4476ed3f8881aa64ab88fbd9b6e474"));
